...
def screencap():
    ...
    try:
        # 截图
        print("截图1")
        os.popen('adb -s 3f7e3e5f shell screencap -p /storage/emulated/0/Pictures/Screenshots/phoneScreencap.png')
        time.sleep(3)

        # 发送到电脑
        os.popen('adb -s 3f7e3e5f pull /storage/emulated/0/Pictures/Screenshots/phoneScreencap.png')
        time.sleep(5)
        # 发送到电脑
        os.popen('adb -s 3f7e3e5f pull /storage/emulated/0/Pictures/Screenshots/phoneScreencap.png')
        time.sleep(7)
        ...
        print(e)
        print("这里有个异常adb -s 3f7e3e5f shell screencap")
...
def phone_detect(fo_count):
    ...
    # del_file(path_data)
    print('home')
    os.popen('adb -s 3f7e3e5f shell input tap 540 1851')
    time.sleep(4)

    print('打开抖音')
    os.popen('adb -s 3f7e3e5f shell input tap 880 1525')
    time.sleep(6)

    # print('打开第一个视频')
    # os.popen('adb -s 3f7e3e5f shell input tap 185 972')
    # os.popen('adb -s 3f7e3e5f shell input tap 185 1583')
    ...
    for my_index in range(0, fo_count, 1):
        ...
        print('分享')
        os.popen('adb -s 3f7e3e5f shell input tap 973 1228')
        time.sleep(3)
        ...
        try:
            if matchImg('phoneScreencap.png', 'comment.png') is not None:
                ...
                print('点击返回')
                os.popen('adb -s 3f7e3e5f shell input tap 838 1850')
                time.sleep(4)
        except Exception as e:
            print(e)
            print("这里有个异常")
        ...
        try:
            ...
            if matchImg('phoneScreencap.png', 'dl.png') is not None:
                ...
                os.popen('adb -s 3f7e3e5f shell input tap ' + myx + ' ' + myy, 'r', 1)
                time.sleep(10)
        ...
        print('点击暂停')
        os.popen('adb -s 3f7e3e5f shell input tap 514 586')
        time.sleep(2)

        print('上划/下一个视频')
        os.popen('adb -s 3f7e3e5f shell input swipe 491 1304 491 333')
        time.sleep(3)

        # print('下划/上一个视频')
        # os.popen('adb -s 3f7e3e5f shell input swipe 491 333 491 1304')
        # time.sleep(3)

        print('开始传文件到电脑')
        os.popen('adb -s 3f7e3e5f pull /storage/emulated/0/DCIM/Camera/ ')
        time.sleep(4)
        print('开始删除手机里的文件')
        os.popen('adb -s 3f7e3e5f shell rm /storage/emulated/0/DCIM/Camera/*.mp4')
        print('结束')
        time.sleep(5)
...
def to_phone_oneplus6():
    print('开始删除手机里的文件')
    # os.popen('adb -s 3f7e3e5f shell rm /storage/emulated/0/1/*')
    # time.sleep(2)
    # print('开始传文件到手机')
    # try:
    #     os.popen(r'adb -s 3f7e3e5f push ./sound/daojishi.mp4 /storage/emulated/0/1/')
    # except Exception as e:
    #     print(e)
    #     print("这里有个异常")
    # time.sleep(3)
    # # print('重启')
    # # os.popen(r'adb -s 3f7e3e5f reboot')
    # # time.sleep(60)
    # #

    print('home  ')
    os.popen('adb -s 3f7e3e5f shell input swipe 485 2279 485 1500 100')
    time.sleep(2)

    print('长按 input swipe 100 100 100 100 1000 ')
    os.popen('adb -s 3f7e3e5f shell input swipe 485 2279 485 1000 5000')
    time.sleep(10)

    # 清除
    print('清除')
    os.popen('adb -s 3f7e3e5f shell input tap 533 1936')
    time.sleep(4)
    ...
    # 打开文件
    print('打开文件')
    os.popen('adb -s 3f7e3e5f shell input tap 142 606')
    time.sleep(4)
    #
    # 点击存储
    print('点击存储')
    os.popen('adb -s 3f7e3e5f shell input tap 411 2194')
    time.sleep(40)
    #
    # # 点击1
    # print('点击1')
    # os.popen('adb -s 3f7e3e5f shell input tap 485 611')
    # time.sleep(5)
    #
    # print('长按 input swipe 100 100 100 100 1000 ')
    # os.popen('adb -s 3f7e3e5f shell input swipe 485 611 485 611 1000')
    # time.sleep(2)
    #
    # print('3dian')
    # os.popen('adb -s 3f7e3e5f shell input tap 1020 143')
    # time.sleep(2)
    #
    # print('分享')
    # os.popen('adb -s 3f7e3e5f shell input tap 676 754')
    # time.sleep(2)
    #
    # print('选抖音')
    # os.popen('adb -s 3f7e3e5f shell input tap 149 1181')
    # time.sleep(30)
    #
    # # print('+')
    # # os.popen('adb -s 3f7e3e5f shell input tap 541 1690')
    # # time.sleep(10)
    #
    # # print('点击上传')
    # # os.popen('adb -s 3f7e3e5f shell input tap 871 1512')
    # # time.sleep(10)
    #
    # # print('选择视频')
    # # os.popen('adb -s 3f7e3e5f shell input tap 149 475')
    # # time.sleep(10)
    #
    # print('下一步')
    # os.popen('adb -s 3f7e3e5f shell input tap 898 204')
    # time.sleep(10)
    #
    # print('下一步')
    # os.popen('adb -s 3f7e3e5f shell input tap 939 1680')
    # time.sleep(15)
    #
    # print('发布')
    # os.popen('adb -s 3f7e3e5f shell input tap 796 1654')
    # time.sleep(10)
...
def sun():
    print('开始摄影')
    print('打开手机相机')
    os.popen('adb -s 3f7e3e5f shell input tap 890 1200')
    time.sleep(10)
    my_time = datetime.datetime.now()
    print("现在时间：" + str(my_time))
    while True:
        if my_time.second % 5 and my_time.hour < 9:
            os.popen('adb -s 3f7e3e5f shell input tap 522 1745')
...
def to_phone():
    ...
    for my_i in range(1, 4, 1):
        ...
        my_pic_file = get_pic()
        time.sleep(1)
        my_adb_push = r'adb -s 3f7e3e5f push  ' + my_pic_file + ' /storage/emulated/0/1/'
        print(my_adb_push)
    ...
    # # 打开文件
    # print('打开文件')
    # os.popen('adb -s 3f7e3e5f shell input tap 520 1200')
    # time.sleep(5)

    # # 点击存储
    # print('点击存储')
    # os.popen('adb -s 3f7e3e5f shell input tap 822 300')
    # time.sleep(40)
    ...
    print('选抖音')
    os.popen('adb -s 3f7e3e5f shell input tap 144 1302')
    time.sleep(30)

    print('+')
    os.popen('adb -s 3f7e3e5f shell input tap 534 1690')
    time.sleep(20)
    ...
    print('选择图片选项卡')
    os.popen('adb -s 3f7e3e5f shell input tap 907 298')
    time.sleep(20)

    print('选择图片1')
    os.popen('adb -s 3f7e3e5f shell input tap 216 422')
    time.sleep(8)
    print('选择图片2')
    os.popen('adb -s 3f7e3e5f shell input tap 502 422')
    time.sleep(8)

    print('下一步')
    os.popen('adb -s 3f7e3e5f shell input tap 949 1684')
    time.sleep(20)
    ...
    print('发布')
    os.popen('adb -s 3f7e3e5f shell input tap 781 1654')
    time.sleep(20)


def comment():
    print('---打开评论')
    os.popen('adb -s 3f7e3e5f shell input tap 997 979')
    time.sleep(3)

    print('---点击空白框')
    os.popen('adb -s 3f7e3e5f shell input tap 127 1685')
    time.sleep(3)

    print('---点击icon')
    for my_c in range(1,random.randint(1,10), 1):

        os.popen('adb -s 3f7e3e5f shell input tap 83 947')
        time.sleep(1)

    for my_c in range(1,random.randint(1,10), 1):
        os.popen('adb -s 3f7e3e5f shell input tap 205 947')
        time.sleep(1)

    for my_c in range(1,random.randint(1,10), 1):
        os.popen('adb -s 3f7e3e5f shell input tap 336 947')
        time.sleep(1)
    
    print('---点发送评论')
    os.popen('adb -s 3f7e3e5f shell input tap 996 679')
    time.sleep(3)

    print('---返回视频')
    os.popen('adb -s 3f7e3e5f shell input tap 241 1844')
    time.sleep(2)
...
def matchImg_up_down(imgsrc, imgobj, my_img_height):
    ...
    for step_y1 in range(my_img_height, 1920, my_img_height):
...
def add_love_comment():
    ...
    for my_index in range(1, 5000, 1):
        print("----------------" + str(my_index) + '    ' + str(datetime.datetime.now()))
        try:
            screencap()
            ...
            if matchImg('phoneScreencap.png', 'add.png') is not None:
                ...
                myx_off = str(matchImg('phoneScreencap.png', 'add.png')['result'][0] + 155 )
                print('点击手机')
                os.popen('adb -s 3f7e3e5f shell input tap ' + myx + ' ' + myy, 'r', 1)
                time.sleep(2)

                print('打开用户')
                os.popen('adb -s 3f7e3e5f shell input tap ' + myx_off + ' ' + myy, 'r', 1)
                ...
                myx_off = str(matchImg('phoneScreencap.png', 'add1.png')['result'][0] + 124 )
                print('点击手机')
                os.popen('adb -s 3f7e3e5f shell input tap ' + myx + ' ' + myy, 'r', 1)
                time.sleep(2)
            ...
            if matchImg('phoneScreencap.png', 'videoisempty.png') is not None or matchImg('phoneScreencap.png', 'pri.png') is not None or matchImg('phoneScreencap.png', 'music.png') is not None:
                ...
                if matchImg('phoneScreencap.png', 'video.png') is not None:
                    ...
                    myy_off = str(matchImg('phoneScreencap.png', 'video.png')['result'][1] + 75 )
                    os.popen('adb -s 3f7e3e5f shell input tap ' + myx + ' ' + myy_off, 'r', 1)
                    time.sleep(5)

                print('点赞')
                os.popen('adb -s 3f7e3e5f shell input tap 997 754')
            ...
            # 滑动屏幕
            os.popen('adb -s 3f7e3e5f shell input swipe 520 1000 520 700 ')
...
def love():
    for my_index in range(1, 200, 1):
        ...
        try:
            print("滑动屏幕")
            os.popen('adb -s 3f7e3e5f shell input swipe 520 1000 520 300 ')
            time.sleep(random.randint(2,3))     
            screencap()
            if matchImg('phoneScreencap.png', 'live.png') is not None:
                print("直播")
                # os.popen('adb -s 3f7e3e5f shell input tap 988 1709')
...
def back_control():
    for my_count_back in range(1, 10, 1):
        ...
        time.sleep(2)
    print("打开抖音")
    os.popen('adb -s 3f7e3e5f shell input tap 121 1291')
    time.sleep(9)
    print("向右滑动屏幕")
    os.popen('adb -s 3f7e3e5f shell input swipe 84 1000 900 1000 ')
    time.sleep(5)
    print("向上滑动屏幕1")
    os.popen('adb -s 3f7e3e5f shell input swipe 520 1100 520 300 ')
    time.sleep(5)
    print("向上滑动屏幕2")
    os.popen('adb -s 3f7e3e5f shell input swipe 520 1100 520 300 ')
    time.sleep(2)
